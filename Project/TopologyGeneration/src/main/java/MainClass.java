...
/**
 * Created by Sulav on 27-10-2016.
 */
public class MainClass {
    ...
    public static void main(String args[]) throws IOException {
      ...
      //String Path = "/home/sulav/IdeaProjects/StormKafka/src/main/java/";
        String Path = "//media/sulav/Work/umkc college/Fall 2016/Real Time Big Data/Project/Storm-Kafka/src/main/java/";
        //String Path = "/home/sulav/Downloads/Storm-Kafka/src/main/java/";
        String line = null;
       ...
       /* while((line = bufferedReader.readLine()) != null) {
        ...
        ParsingNew parsing0 = new ParsingNew(model, "data/Class0.txt", "0.0");
        ...
        String[] bolts = {"Class0", "Class1","Class2"};
        String[] classDTpaths = {"data/Class0.txt", "data/Class1.txt","data/Class2.txt"};
